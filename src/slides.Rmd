...
* Git is version control software, inititally developed for version control of the Linux operating system kernel.
* It is now extremely widely used for almost all kinds of software development projects. 
* Git works on a decentralized system whereby a codebased can be *cloned*, developed independently, and possible remerged. 
...
- RMarkdown (and knitr) and Jupyter notebooks are two complementary approaches to coupling data, code, and explantory text. 
